...
\begin{itemize}
	...
	\begin{equation}
	\vcenter{\hbox{\includegraphics[scale=0.5]{translation-invariance.png}}}
	\end{equation}
...
\begin{itemize}
	...
	\item \cc{我浪费了两年时间试图解决这问题，却发现在3年前已经有两篇论文解决了 [PointNet 2017] [DeepSets 2018]，而且数学水平比我高很多！
	}
...
\begin{itemize}
	...
	\end{equation}
	\item 而这些 edges 需要 \emp{symmetric} NN 处理，因为它们在 置换下 是不变的
...
\begin{itemize}
	...
	\begin{equation}
	\vcenter{\hbox{\includegraphics[scale=0.6]{new-BERT.png}}}
	\end{equation}
...
\begin{frame}[plain]
\begin{itemize}
	\item 集合元素 $a$ 是 $\forall x. P(x)$ 的证明，例如 Socrates 是 $\forall x. \mbox{Mortal}(x)$ 的证明
	...
	\item 这套漂亮的理论 不是无用的； 长远来说，它可以指导 深度学习 和 逻辑 之间的 融合，例如\emp{解释}一些 vectors 的逻辑含义
\end{itemize}
\end{frame}
