...
\title{\cc{\bfseries\color{blue}{\Huge《深度逻辑》} \\ \vspace*{0.2cm} 統一 邏輯、深度學習、與人工智能}
...
\subsection{Symmetric neural network}
\begin{itemize}
...
\subsection{\cc{知识图谱 (knowledge graphs)}{Knowledge graphs}}
\begin{itemize}
...
%\tikzcdset{arrow style=tikz, diagrams={>={|[scale=3]}}}
\subsection{\cc{逻辑 与 AI 之间的联系}
...
\subsection{\cc{谓词 (predicates) vs 命题 (propositions)}
...
\section{BERT as an alternative logic}

\subsection{\cc{BERT 的革命性意义：「闭环路训练」}
...
\subsection{\cc{BERT 的逻辑化}{Logicalization of BERT}}
\begin{itemize}
...
\subsection{\cc{Attention 是什么？}{What is attention?}}
\begin{itemize}
...
\subsection{\cc{BERT 为什么成功？}{Why is BERT so successful?}}
\begin{itemize}
...
\subsection{\cc{改良 BERT： 类似 attention 的方法}{Modifying BERT with an attention-like mechanism}}
\begin{itemize}
...
\subsection{\cc{逆因推理 (abduction) 与 自然语言理解}{Abductive interpretation of natural language}}
\begin{itemize}
...
\subsection{\cc{捕捉更广泛的 semantics}{Capturing semantics more broadly}}
\begin{itemize}
...
\subsection{Content-addressable long-term memory}
\begin{itemize}
