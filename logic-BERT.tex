...
\title[Logic BERT]{Supplement 1: \vspace*{0.3cm} \\ {\Huge《Logic BERT》}}
...
\begin{itemize}
	...
	\item \cc{原来的 encoder 可以照旧使用，，因为它是一个 universal seq-2-seq mapping}
...
\item 假设 $q$ 是（包含多个命题的）逻辑 state，$\bowtie$ 表示 matching by attention:
	\begin{equation}
	q \bowtie \mbox{rule} \rightarrow \mbox{conclusion}
	\end{equation}
