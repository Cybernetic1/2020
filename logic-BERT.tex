...
\item \cc{但从 $M$ 个命题中选择 $N$ 个，可以有 $M \choose N$ 个子集，是 exponential}
{But to choose $N$ propositions from a set of $N$, there would be $M \choose N$ subsets, an \emp{exponential} number}
\end{itemize}
\end{frame}
